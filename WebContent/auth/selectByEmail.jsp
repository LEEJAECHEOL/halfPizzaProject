...
<%@ include file="../layouts/header.jsp" %>
    <main>
        <div class="container">
            <div class="sub-p-title">
                <h3 class="underLine"><span>아이디 찾기</span></h3>
            </div>
            ...
            <div class="subpage-box">
                ...
                <div class="agree-form">
                    <h3>이메일로 찾기</h3>
                        ...
                        <button type="button" class="btn-blue" id="searchId">아이디 찾기</button>
                </div>
    ...
    <div id="selectByEmail">
        <div id="selectSuccess">
            <h3>회원님의 아이디는</h3>
            <p><span>아이디 : </span><b id="succsessID"></b></p>
            <button id="closeBox">닫기</button>
        </div>
        <div id="selectFail">
            <h3>회원님의 아이디를 찾을 수 없습니다.</h3>
    ...
    <script>
        ...
        document.querySelector('#searchId').addEventListener('click', function(){
			...
			$.ajax({
				type : "GET",
				url : "http://localhost:8000/halfPizza/auth/findMyEmail?email=" + _ckEmail+"&name="+_ckName,
